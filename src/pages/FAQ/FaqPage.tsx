...
import faqBackgroundImage from '../../assets/paper.png';
...
function FaqPage() {
  ...
  if (isOpen && isFirst && isSecond === false && isThird === false) {
    faqAnswer = (
      <>
        <BackgroundImage backgroundImageUrl={faqBackgroundImage} />
        <div role="button" tabIndex={0} onKeyPress={() => handleKeyPress} onClick={handleOnClickFirst} className={styles.AnswerContainer}>
    ...
    faqAnswer = (
      <>
        <BackgroundImage backgroundImageUrl={faqBackgroundImage} />
        <div role="button" tabIndex={0} onKeyPress={() => handleKeyPress} onClick={handleOnClickSecond} className={styles.AnswerContainer}>
    ...
    faqAnswer = (
      <>
        <BackgroundImage backgroundImageUrl={faqBackgroundImage} />
        <div role="button" tabIndex={0} onKeyPress={() => handleKeyPress} onClick={handleOnClickThird} className={styles.AnswerContainer}>
